...
public class GAQService extends AbstractQuotationService {
	...
	/**
	 * Quote generation: 50% discount for being female 30% surcharge for being a mam
	 * upto 20% discount for being low BMI 20% penalty for high BMI 20% penalty for
	 * Medical Issues 40% penalty for smoking
	 */
	@Override
